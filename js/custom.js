(function($) {
	...
	$(document).ready(function() {
		...
		$(".contactform").on("submit", function() {
			...
			let name = $(".output_message").text("Sending...");
			let email = $(".output_message").text("Sending...");
			let assunto =$(".output_message").text("Sending...");
			let messagem = $(".output_message").text("Sending...");
			
			let url = "https://resources.nuxo.ao/port/mailsender.php";
